...
/* ════════════════════════════════════════════════════════════════
   ...
   SEO improved for Google indexing and keyword visibility
   ════════════════════════════════════════════════════════════════ */
...
const SERVICES = [
  {
    ...
    description:
      'Scalable, performant web applications tailored to your business logic — from MVPs to admin dashboards and enterprise platforms.',
    num: '01',
  },
  {
    icon: Palette,
    title: 'UI / UX Design',
    description:
      'Pixel-perfect interfaces with intuitive user flows that help visitors understand, trust, and connect with your business.',
    num: '02',
  },
  {
    icon: ShoppingCart,
    title: 'E-commerce',
    description:
      'High-converting online stores with product management, smooth checkout experiences, and payment integration support.',
    num: '03',
  },
  {
    icon: Search,
    ...
    description:
      'Fast loading websites, search-friendly content, Core Web Vitals improvements, and visibility-focused development.',
    num: '04',
  },
];
...
const PROJECTS = [
  {
    ...
    description:
      'Real-time analytics platform with role-based access and custom reporting for enterprise teams.',
  ...
  },
  {
    ...
    description:
      'Premium shopping experience with AR try-on and curated collections for discerning buyers.',
  ...
  },
  {
    ...
    description:
      'Bold brand storytelling for a fintech firm with investor portal and real-time market feeds.',
...
const SEO_KEYWORDS = [
  'Web design agency in Sri Lanka',
...
function Noise() {
  return (
    <svg
      className="fixed inset-0 w-full h-full pointer-events-none -z-10 opacity-[0.028]"
...
function HeroVisual({ mouseX, mouseY }) {
  ...
  return (
    ...
    >
      ...
      >
        <div
          className="absolute inset-0 -z-10 opacity-20 rounded-3xl overflow-hidden"
          style={{
        ...
        <div
          className="absolute bottom-1/4 right-1/5 w-36 h-36 bg-brand-mid/30 rounded-full blur-3xl animate-pulse-glow"
          style={{ animationDelay: '1.4s' }}
        />

        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
          <div
            className="absolute w-3 h-3 rounded-full bg-brand-glow shadow-[0_0_12px_4px_rgba(75,223,184,0.7)]"
            style={{ animation: 'orbit 22s linear infinite' }}
          />
          <div
            className="absolute w-2 h-2 rounded-full bg-brand-bright/70"
            style={{ animation: 'orbitRev 18s linear infinite' }}
          />
        </div>

        <div
          className="absolute inset-6 rounded-2xl overflow-hidden animate-float"
          style={{
            background:
              'linear-gradient(135deg, rgba(10,28,23,0.92) 0%, rgba(5,15,12,0.96) 100%)',
            backdropFilter: 'blur(24px)',
            border: '1px solid rgba(75,223,184,0.15)',
            boxShadow:
              '0 0 0 1px rgba(75,223,184,0.06), 0 40px 80px -20px rgba(0,0,0,0.8), 0 0 60px -10px rgba(47,160,132,0.25)',
          }}
        >
          ...
          <div className="px-5 pb-5 pt-3">
            ...
            <div className="h-[3px] w-full rounded-full bg-surface-800 overflow-hidden">
              <div
                className="h-full w-[96%] rounded-full bg-gradient-to-r from-brand-dark via-brand-bright to-brand-glow animate-shimmer"
          ...
          <div className="mx-5 mb-5 grid grid-cols-3 gap-2">
            {[
              ...
              <div
                key={label}
                className="rounded-lg bg-brand-light/[0.07] border border-brand-light/10 py-2 text-center"
              >
                <div className="text-base font-bold font-display text-brand-glow">
                  {val}
                </div>
        ...
        <div
          className="absolute -bottom-3 -left-3 px-3 py-1.5 rounded-xl text-xs font-semibold flex items-center gap-1.5"
          style={{
            background: 'rgba(10,28,23,0.9)',
...
function SectionLabel({ children }) {
  return (
    <div className="inline-flex items-center gap-2 mb-4">
      ...
      <span className="text-xs font-mono uppercase tracking-[0.22em] text-brand-bright">
        {children}
      </span>
      <div className="w-6 h-px bg-brand-bright" />
    </div>
    ...
    <div className="min-h-screen overflow-x-hidden font-sans text-brand-muted">
      ...
      <div className="fixed inset-0 -z-20 pointer-events-none">
        <div
          style={{
            background:
              'linear-gradient(160deg, #010806 0%, #050F0C 40%, #020806 100%)',
          }}
          className="absolute inset-0"
        />

        <div
          className="absolute -top-40 -left-40 w-[700px] h-[700px] rounded-full opacity-20 blur-[120px]"
          style={{
            background: 'radial-gradient(circle, #2FA084 0%, transparent 70%)',
          }}
        />

        <div
          className="absolute -bottom-32 -right-32 w-[600px] h-[600px] rounded-full opacity-15 blur-[100px]"
          style={{
            background: 'radial-gradient(circle, #1F6F5F 0%, transparent 70%)',
          }}
        />
        ...
        <div
          ...
          style={{
            background: 'radial-gradient(circle, #4BDFB8 0%, transparent 70%)',
          }}
        />
      </div>
      ...
      >
        <nav
          className={`mx-auto max-w-6xl px-4 sm:px-6 transition-all duration-500 ${
            scrolled ? 'rounded-2xl shadow-2xl shadow-black/40' : 'bg-transparent'
          }`}
          style={
            scrolled
              ? {
        ...
        >
          <div className="flex items-center justify-between h-14 px-2 sm:px-4">
            <a
              ...
              aria-label="ProtosTrio homepage"
              onClick={(e) => {
                e.preventDefault();
            ...
            >
              <div
                className="relative w-9 h-9 rounded-xl overflow-hidden flex items-center justify-center shadow-lg"
                style={{
              ...
              >
                {!logoError ? (
                  <img
                    src="/logo.jpeg"
                    alt="ProtosTrio web agency logo"
        ...
        <div
          className={`md:hidden fixed inset-0 top-[72px] z-40 transition-all duration-400 ${
            menuOpen
        ...
        >
          <div
            className="absolute inset-0 bg-surface-950/90 backdrop-blur-2xl"
            onClick={() => setMenuOpen(false)}
          />

          <ul
            className="relative mx-4 mt-4 rounded-2xl p-4 space-y-1"
            style={{
              background: 'rgba(10,28,23,0.95)',
              border: '1px solid rgba(75,223,184,0.12)',
            }}
          >
            {NAV_LINKS.map((link) => (
      ...
      <main>
        ...
        >
          ...
          <div className="max-w-6xl mx-auto w-full grid lg:grid-cols-2 gap-14 lg:gap-20 items-center">
            <div className="text-center lg:text-left order-2 lg:order-1 animate-fade-up">
              <div
                className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full mb-7 text-sm text-brand-faint"
                style={{
                  background: 'rgba(75,223,184,0.06)',
              ...
              <h1 className="font-display text-5xl sm:text-6xl lg:text-7xl font-extrabold tracking-tight leading-[1.05] mb-6">
                ...
                <span className="relative inline-block">
                  <span
                    className="relative z-10 bg-clip-text text-transparent bg-gradient-to-r from-brand-bright via-brand-glow to-brand-bright animate-gradient-x"
              ...
              <p className="text-base sm:text-lg text-slate-400 max-w-xl mx-auto lg:mx-0 mb-9 leading-relaxed">
                ProtosTrio is a web design and IT solutions agency in Sri Lanka.
                We build modern websites, custom web applications, e-commerce
                platforms, UI/UX designs, and digital solutions for startups,
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                <button
                  ...
                  style={{
                    background:
                      'linear-gradient(135deg, #1F6F5F 0%, #3BBFA0 100%)',
                    boxShadow:
                      '0 0 30px rgba(47,160,132,0.35), 0 4px 20px rgba(0,0,0,0.4)',
                  }}
                >
                  Start a Project
              ...
              <div className="flex items-center gap-6 mt-10 justify-center lg:justify-start text-xs text-slate-500">
                {[
                  ...
                  <div key={l} className="text-center">
                    <div className="font-display font-bold text-base text-brand-bright mb-0.5">
                      {v}
                    </div>
                    <div>{l}</div>
                  </div>
        ...
        <section className="px-4 sm:px-6 pb-10">
          <div
            className="max-w-6xl mx-auto rounded-2xl p-6 sm:p-8"
            style={{
              background: 'rgba(10,28,23,0.45)',
              border: '1px solid rgba(75,223,184,0.08)',
            }}
          >
            <h2 className="font-display text-2xl sm:text-3xl font-bold mb-4 text-brand-muted">
              ProtosTrio — Web Design Agency & IT Solutions Team in Sri Lanka
            </h2>

            <p className="text-slate-400 text-sm sm:text-base leading-relaxed mb-5">
              ProtosTrio is a Sri Lankan web agency focused on building
              professional websites, business web applications, e-commerce
              stores, landing pages, admin dashboards, and digital platforms.
              Our team helps local businesses, startups, and entrepreneurs
              create fast, modern, mobile-friendly, and search-friendly websites.
            </p>
            ...
            <div className="flex flex-wrap gap-2">
              {SEO_KEYWORDS.map((keyword) => (
                <span
                  key={keyword}
                  className="px-3 py-1.5 rounded-full text-xs font-mono text-brand-bright"
                  style={{
                    background: 'rgba(75,223,184,0.06)',
                    border: '1px solid rgba(75,223,184,0.12)',
                  }}
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <h2 className="font-display text-4xl sm:text-5xl font-bold mb-4">
                Services built for{' '}
                <span className="bg-clip-text text-transparent bg-gradient-to-r from-brand-bright to-brand-glow">
                  growth
                </span>
              </h2>

              <p className="text-slate-400 max-w-2xl mx-auto">
                We provide website development, React web apps, MERN stack
                applications, e-commerce website development, UI/UX design, SEO
                optimization, and custom IT solutions for businesses in Sri Lanka
                and beyond.
              </p>
            </div>
              ...
              {SERVICES.map((svc) => (
                ...
                >
                  <div
                    ...
                    style={{
                      background:
                        'radial-gradient(circle at 50% 0%, rgba(75,223,184,0.07) 0%, transparent 70%)',
                    }}
                  />

                  <div className="font-mono text-[11px] tracking-widest text-brand-mid mb-4">
                    {svc.num}
                  </div>
                  ...
                  <div
                    ...
                    style={{
                      background:
                        'linear-gradient(135deg, rgba(31,111,95,0.6), rgba(75,223,184,0.2))',
                      border: '1px solid rgba(75,223,184,0.15)',
                    }}
                  >
          ...
          <div className="max-w-6xl mx-auto">
            <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-8 mb-16">
              ...
              <p className="text-slate-400 max-w-sm text-sm leading-relaxed">
                Selected website, web application, and e-commerce projects
                showcasing our range — from SaaS dashboards to luxury retail
                experiences.
              </p>
            </div>
                ...
                >
                  <div className="relative aspect-[4/3] overflow-hidden bg-slate-950">
                    {proj.image ? (
                      <img
                        src={proj.image}
                        alt={`${proj.title} web development project preview by ProtosTrio`}
                      ...
                      <div
                        ...
                        style={{
                          background: `linear-gradient(135deg, ${proj.hue} 0%, #020806 100%)`,
                        }}
                      />
                    )}
                    ...
                    <div
                      className="absolute inset-4 rounded-xl border opacity-20 group-hover:opacity-40 transition-opacity duration-500"
                      style={{ borderColor: proj.accent }}
                    />

                    <div
                      className="absolute inset-8 rounded-lg border opacity-10 group-hover:opacity-25 transition-opacity duration-700"
                      style={{ borderColor: proj.accent }}
                    />

                    <span
                      className="absolute top-4 left-4 px-2.5 py-1 rounded-md text-[11px] font-mono font-semibold uppercase tracking-wider"
                      style={{
                        background: 'rgba(5,15,12,0.85)',
                    ...
                    <div
                      className="absolute top-4 right-4 p-2 rounded-lg opacity-0 group-hover:opacity-100 transition-all duration-300 translate-y-2 group-hover:translate-y-0"
                      style={{
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-slate-400 max-w-xl mx-auto">
                Three passionate builders united by a love for clean code,
                beautiful design, and client success.
              </p>
            </div>
              ...
              {TEAM.map((member) => (
                ...
                >
                  ...
                  <div className="relative mx-auto w-24 h-24 mb-6 group-hover:scale-105 transition-transform duration-300">
                    <div
                      className="w-full h-full rounded-2xl flex items-center justify-center text-3xl font-display font-bold text-brand-muted"
                      style={{
                        background: `linear-gradient(135deg, #1A5C4E, #4BDFB8)`,
                  ...
                  <h3 className="font-display text-xl font-bold mb-1 text-brand-muted">
                    {member.name}
                  </h3>

                  <p className="text-xs font-mono text-brand-bright/80 mb-4 tracking-wide">
                    {member.role}
                  </p>
                      ...
                      <a
                        ...
                        onMouseEnter={(e) => {
                          ...
                          e.currentTarget.style.boxShadow =
                            '0 0 15px rgba(75,223,184,0.4)';
                        }}
                        onMouseLeave={(e) => {
                          e.currentTarget.style.background =
                            'rgba(75,223,184,0.06)';
                          e.currentTarget.style.border =
                            '1px solid rgba(75,223,184,0.12)';
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-start">
              <div>
                ...
                <p className="text-slate-400 mb-8 leading-relaxed">
                  Tell us about your project. Whether you need a business
                  website, landing page, e-commerce store, custom web
                  application, admin dashboard, or UI/UX design, ProtosTrio can
                  help you build a modern digital solution for your business.
                </p>

                <a
                  href="mailto:protostrio26@gmail.com"
              ...
              <div
                ...
                style={{
                  ...
                  border: '1px solid rgba(75,223,184,0.12)',
                  boxShadow:
                    '0 0 60px rgba(47,160,132,0.1), 0 20px 60px rgba(0,0,0,0.5)',
                  backdropFilter: 'blur(20px)',
                }}
              >
                {submitted ? (
                  <div className="py-16 text-center">
                    <div
                      ...
                      style={{
                        background:
                          'linear-gradient(135deg, #1F6F5F, #3BBFA0)',
                        boxShadow: '0 0 30px rgba(47,160,132,0.4)',
                      }}
                    >
                      <Send className="w-7 h-7 text-white" />
                    </div>

                    <h3 className="font-display text-xl font-bold mb-2 text-brand-muted">
                      Message sent!
                    </h3>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    <div>
                      <label
                        htmlFor="name"
                        className="block text-xs font-mono uppercase tracking-widest text-slate-500 mb-2"
                      >
                        Name
                      </label>
      ...
      <footer
        style={{
          borderTop: '1px solid rgba(75,223,184,0.12)',
          background: 'rgba(5,15,12,0.9)',
        }}
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="flex items-center gap-2.5">
              ...
              >
                {!logoError ? (
                  <img
                    src="/logo.jpeg"
                    alt="ProtosTrio web design agency logo"
                    className="w-full h-full object-cover"
                    onError={() => setLogoError(true)}
                  />
                ) : (
              ...
              <span className="font-display font-bold text-brand-muted">
                ProtosTrio
              </span>
            </div>
            ...
            <div className="flex gap-2.5">
              {[
                { Icon: Github, url: 'https://github.com/baranaSubasinghe' },
                {
                  Icon: Linkedin,
                  url: 'https://www.linkedin.com/company/protostrio',
                },
                { Icon: Twitter, url: 'https://twitter.com/protostrio' },
                { Icon: Mail, url: 'mailto:protostrio26@gmail.com' },
              ].map(({ Icon, url }, i) => (
                <a
                  key={i}
                  href={url}
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="ProtosTrio social link"
                  ...
                  onMouseEnter={(e) => {
                    e.currentTarget.style.background =
                      'rgba(75,223,184,0.15)';
                    e.currentTarget.style.color = '#4BDFB8';
                  }}
                  onMouseLeave={(e) => {
                    e.currentTarget.style.background =
                      'rgba(75,223,184,0.05)';
          ...
          <div
            className="mt-8 pt-8 text-center text-xs text-slate-600 space-y-2"
            style={{ borderTop: '1px solid rgba(75,223,184,0.07)' }}
          >
            <p>
              © {new Date().getFullYear()} ProtosTrio. Crafted with care by
              Barana, Chamudi & Hasini.
            </p>

            <p>
              ProtosTrio is a web design and IT solutions agency in Sri Lanka
              offering website development, web applications, e-commerce
              development, UI/UX design, SEO optimization, and custom software
              solutions.
            </p>
          </div>
        </div>
